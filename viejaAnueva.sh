	...
	case "${FLAG}" in
      ...
      preguntarPass          preguntarPass
		...
		*)
		...
		echo "El formato del comando para actualizar base con datos de producción: viejaAnueva -a nombreBase."
		echo "El formato del comando para realizar backup de la base actual es: viejaAnueva -b nombreBase."
		echo "El formato del comando para recuperar la base con un backup local es: viejaAnueva -r nombreBase."
		echo "El formato del comando para ver las bases actuales cargadas en mysql-server es: viejaAnueva -s."
	esac
done
